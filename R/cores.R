...
common_core <- function(otu, map, mini_abun=0, threshold=0.01) {
...
get_avg_rel_abun <- function(otu, map, otu_ranked, BC_ranked_abun) {
...
get_avg_occ <- function(otu, map, otu_ranked, BC_ranked_abun) {
...
dis_occ <- function(otu, map, mini_abun, threshold) {
