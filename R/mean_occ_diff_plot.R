...
mean_occ_diff_plot <- function(otu, sample, min_abun, max_abun, abun_step, min_thre, max_thre, thre_step, sample_name, sample_group){ # , height, weight
  ...
  p <- dis_occ_loop(otu, sample, min_abun = min_abun, max_abun = max_abun, abun_step = abun_step, min_thre = min_thre, max_thre = max_thre, thre_step = thre_step, sample_name, sample_group)
  p
}
