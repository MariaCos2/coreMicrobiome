...
##' 
##' @description Plots the importance of otu on predicting/classifying the SampleType and the accuracy using core otu, non-core otu and all otu. 
...
##' @param ...
##' @details Plots the importance of otu on predicting/classifying the SampleType and the accuracy using core otu, non-core otu and all otu. 
##' @return A bar plot showing importance of otu on predicting/classifying the SampleType and a bar plot showing the accuracy using core otu, non-core otu and all otu. 
##' @examples
##'  random_forest_plot(otu, sample, mini_abun=0, threshold=0.02, height=400, weight=400)
##' @export
##' 
random_forest_plot <- function(otu, sample, mini_abun, threshold){
  ...
  map_sub <- sample %>% select(Sample_ID, SampleType)
